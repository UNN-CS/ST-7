...
public class App
{
    ...
    {
        System.setProperty("webdriver.chrome.driver", "C:\\Users\\EncorePC\\Desktop\\chromedriver-win64\\chromedriver.exe");
        ...
        try {
            ...
            String artistName = "OsamaSon";
            String albumTitle = "Flex Musix";
            String[] tracks = {
                    "Blonde",
                    "Baghdad",
                    "All Star",
