...
public class Application {
    ...
    private static final String NAME_CHROME_DRIVER_PATH =
            "C:\\Users\\sskam\\OneDrive\\chromedriver.exe";
    ...
    //
    private final BibBabyTapeAlbum bibBabyTapeAlbum;
    private final WebDriver webDriver;

    private Application(BibBabyTapeAlbum bibBabyTapeAlbum) {
        this.bibBabyTapeAlbum = bibBabyTapeAlbum;
        try {
    ...
    public void startWorkTheWebDriver() {
        try {
            ...
            findElementByXpathName(NAME_ARTIST_INPUT_XPATH).sendKeys(bibBabyTapeAlbum.getArtistName());
            findElementByXpathName(NAME_TITLE_INPUT_XPATH).sendKeys(bibBabyTapeAlbum.getTitleAlbum());

            List<String> tracks = bibBabyTapeAlbum.getMusicsTracks();
